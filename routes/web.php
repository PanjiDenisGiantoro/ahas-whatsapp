...
use App\Http\Controllers\SwitchDeviceController;
...
Route::middleware('installed.app','isVerifiedLicense','auth')->group(function(){
    ...
    Route::get('/greeting/{id}', [GreetingController::class, 'greeting'])->name('greeting');
    Route::get('/greetingtes', [GreetingController::class, 'tes'])->name('tes');

    Route::get('/bye/{id}', [GreetingController::class, 'bye'])->name('bye');

    Route::post('/fetchtemplate', [TemplateController::class, 'fetchtemplate'])->name('fetch.template');

 Route::get('/template', [TemplateController::class, 'index'])->name('t.i');

 Route::get('/template-get', [TemplateController::class, 'getTemplate'])->name('dt.gt');

 Route::post('/template/save', [TemplateController::class, 'saveTemplate'])->name('t.s');

 Route::put('/template/update', [TemplateController::class, 'editTemplate'])->name('t.u');

Route::delete('/template/delete', [TemplateController::class, 'destroy'])->name('t.d');





    Route::post('/greeting/save', [GreetingController::class, 'saveCustomer'])->name('g.sc');

    Route::get('/greeting', [GreetingController::class, 'index'])->name('g.i');
 ...
 Route::post('/file-manager-load-more',[FileManagerController::class,'loadMore']);

 Route::get('/file-manager-delete/{id}',[FileManagerController::class,'deleteFile']);
 ...
 Route::post('/contact_edit/{id}',[ContactController::class,'update']);
 ...
 Route::get('/campaign/gettemplate',[CampaignController::class,'gettemplate'])->name('campaign.gettemplate');

 Route::get('cron',[CampaignController::class,'cron'])->name('campaign.cron');

 Route::post('cron_ulang',[CampaignController::class,'cron_ulang'])->name('campaign.cron_ulang');

 Route::post('cron_kpb',[CampaignController::class,'cron_kpb'])->name('campaign.cron_kpb');

 Route::post('cron_promo',[CampaignController::class,'cron_promo'])->name('campaign.promo');

 Route::post('cron_save',[CampaignController::class,'cron_save'])->name('campaign.save');

 Route::post('cron_save_batch',[CampaignController::class,'cron_save_batch'])->name('campaign.save_batch');

 Route::get('auto_ulang_tahun',[MessagesController::class,'auto_ulang_tahun'])->name('campaign.auto_ulang_tahun');
 ...
 Route::get('/blast/histories/export/{blast:campaign_id}',[BlastController::class,'export'])->name('blastExport');
...
// switch
    ...
    Route::get('/admin_switch_devie',[SwitchDeviceController::class,'index']);

    Route::post('/admin_switch_device_store',[SwitchDeviceController::class,'store']);

    Route::get('/admin_switch_device_delete/{id}',[SwitchDeviceController::class,'delete']);

    Route::post('admin_switch_device_update/{id}',[SwitchDeviceController::class,'update']);
...
Route::post('/install_apps_final', [SettingController::class,'postInstall']);



Route::post('/settings/check_database_connection',[SettingController::class,'checkDb']);

Route::post('/settings/check_node_port',[SettingController::class,'checkNode']);
