                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST" enctype="multipart/form-data" id="formUser">
                                    ...
                                    <label for="nama_ahas" class="form-label">Nama Ahass</label>
                                    <input type="text" name="nama_ahas" id="nama_ahas" class="form-control" value="" >
                                    <label for="kode_ahas" class="form-label">Kode Ahass</label>
                                    <input type="text" name="kode_ahas" id="kode_ahas" class="form-control" value="" >
                                    <label for="kota" class="form-label">Kota</label><br>
                                    <select name="kota" id="kota" class="form-control">
                                        <option value="">Pilih Kota</option>
                                        @foreach ($kota as $kotas)
                                            <option value="{{$kotas->id}}">{{$kotas->name}}</option>
                                        @endforeach
        ...
        function editUser(id){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#kota').val(data.kota);
                    $('#nama_ahas').val(data.nama_ahas);
                    $('#kode_ahas').val(data.kode_ahas);
                    $('#iduser').val(data.id);
                }
            });
        }
