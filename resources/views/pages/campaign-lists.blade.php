  ...
  <div class="col">
      ...
      <div class="card">
          ...
          <div class="card-body">
              ...
              <table id="datatable1" class="display table-striped table-hover table-" style="width:100%;border-radius: 1em;
  overflow: hidden;">
                  ...
                  <thead class="bg-primary">
                      ...
                      <tr>
                          ...
                          <th style="color: whitesmoke">Sender</th>

                          <th style="color: whitesmoke">Name Campaign</th>
                            ...
                            <th style="color: whitesmoke">Schedule</th>

                          <th style="color: whitesmoke">Status</th>

                           <th class="d-flex justify-content-center" style="color: whitesmoke">Cetak</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                         ...
                         <td><a href="{{route('blastExport',$campaign->id)}}" class="btn btn-success" >
